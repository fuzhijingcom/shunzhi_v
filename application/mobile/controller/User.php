...
//        $this->success($data['msg']);
    ...
    public function add_address()
    {
        if (IS_POST) {
            ...
            if ($data['status'] != 1){
                ...
                exit;
            }elseif(I('post.source') == 'kd') {
                header('Location:' . U('kuaidi/xiadan/xiadan', array('address_id' => $data['result'],'type'=>I('type'))));
                exit;
            }elseif(I('post.source') == 'box') {
                header('Location:' . U('box/xiadan/xiadan', array('address_id' => $data['result'],'type'=>I('type'))));
                exit;
            }elseif(I('post.source') == 'ss') {
                header('Location:' . U('song/xiadan/xiadan', array('address_id' => $data['result'],'type'=>I('type'))));
                exit;
            }
    ...
    public function edit_address()
    {
        ...
        if (IS_POST) {
            ...
            if ($_POST['source'] == 'kd') {
                header('Location:' . U('kuaidi/xiadan/xiadan', array('address_id' => $id,'type'=>I('type'))));
                exit;
            }elseif ($_POST['source'] == 'cart2') {
                header('Location:' . U('/Mobile/Cart/cart2', array('address_id' => $id)));
                exit;
            }elseif ($_POST['source'] == 'box') {
                 header('Location:' . U('box/xiadan/xiadan', array('address_id' => $id,'type'=>I('type'))));
                exit;
            }elseif ($_POST['source'] == 'ss') {
                 header('Location:' . U('song/xiadan/xiadan', array('address_id' => $id,'type'=>I('type'))));
                exit;
            }
