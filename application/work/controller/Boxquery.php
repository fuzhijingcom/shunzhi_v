...
use think\Page;
use think\Db;
class Boxquery extends MobileBase {
    ...
    */
    ...
    public function search(){
        ...
        $read = D('kd_order_box')->where($condition)->order('order_id desc')->select();
    ...
    public function detail(){
       ...
       $order_id = I('order_id');
        ...
        $read = D('kd_order_action_box')->where(array('order_id' => $order_id))->select();
